export const ptBRMessages = {
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_tip": "Permite subdomínios manuais em /api/new_address e /admin/new_address somente quando o domínio base também permite subdomínios aleatórios.",
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_note": "Este é o modo manual dentro de RANDOM_SUBDOMAIN_DOMAINS: o chamador informa o subdomínio, enquanto o modo aleatório o gera automaticamente.",
  ...
  "views.admin.CreateAccount.customSubdomain": "Subdomínio personalizado",
  "views.admin.CreateAccount.customSubdomainTip": "Digite apenas a parte do subdomínio. Este modo só está disponível para domínios base que permitem subdomínios aleatórios.",
  "views.admin.CreateAccount.enableCustomSubdomain": "Usar subdomínio personalizado",
  "views.common.Login.customSubdomain": "Subdomínio personalizado",
  "views.common.Login.customSubdomainRequired": "Digite um subdomínio personalizado.",
  "views.common.Login.customSubdomainTip": "Digite apenas a parte do subdomínio. Este modo só está disponível para domínios base que permitem subdomínios aleatórios.",
