export const ptBRMessages = {
  ...
  "views.Admin.account": "Gerenciamento de caixas de correio",
  "views.Admin.account_list": "Caixas de correio",
  "views.Index.accountSettings": "Configurações da caixa de correio",
  "views.Admin.account_settings": "Configurações globais de caixas de correio",
  "views.index.SimpleIndex.accountSettings": "Configurações da caixa de correio",
  ...
  "components.AddressSelect.address": "Selecionar caixa de correio",
  "views.user.AddressManagement.address": "Caixas de correio",
  "views.index.TelegramAddress.address": "Caixas de correio",
  "views.admin.SenderAccess.address": "Endereço de e-mail",
  "views.index.LocalAddress.address": "Caixas de correio locais",
  "views.admin.CreateAccount.address": "Endereço de e-mail",
  ...
  "views.index.SimpleIndex.addressCopied": "Endereço de e-mail copiado",
  "views.admin.Statistics.addressCount": "Quantidade de endereços",
  "views.admin.UserManagement.address_count": "Quantidade de caixas de correio",
  "views.User.address_management": "Gerenciamento de caixas de correio",
  "views.admin.UserManagement.userAddressManagement": "Gerenciamento de caixas de correio",
  "views.index.AddressBar.addressPassword": "Senha da caixa de correio",
  "views.admin.CreateAccount.addressPassword": "Senha da caixa de correio",
  "views.Admin.adminAccount": "Administrador",
  "views.Admin.accessHeader": "Senha de administrador",
  "views.Admin.loginViaPassword": "Login com senha de administrador",
  ...
  "views.admin.Account.deleteTip": "Tem certeza de que deseja excluir a caixa de correio {address} e todos os e-mails dela?",
  "views.admin.SenderAccess.deleteTip": "Tem certeza de que deseja excluir isto?",
  "views.index.AccountSettings.deleteAccountConfirm": "Tem certeza de que deseja excluir a caixa de correio {address} e todos os e-mails dela? Isso não exclui sua conta de usuário.",
  ...
  "views.Admin.logoutConfirmContent": "Tem certeza de que deseja sair do painel administrativo?",
  ...
  "views.user.AddressManagement.unbindAddressTip": "Abra esta caixa de correio antes de desvinculá-la e salve a credencial do endereço.",
  "views.index.TelegramAddress.bind": "Adicionar caixa de correio",
  "views.index.TelegramAddress.bindAddressSuccess": "Caixa de correio vinculada com sucesso",
  "views.index.LocalAddress.bindAddressSuccess": "Caixa de correio adicionada com sucesso",
  ...
  "views.user.AddressManagement.changeMailAddress": "Abrir caixa de correio",
  "views.index.TelegramAddress.changeMailAddress": "Trocar caixa de correio",
  "views.index.LocalAddress.changeMailAddress": "Trocar caixa de correio",
  "views.index.AccountSettings.changePassword": "Alterar senha da caixa de correio",
  ...
  "views.admin.RoleAddressConfig.roleConfigDesc": "Configure o número máximo de caixas de correio para cada função de usuário. Os limites por função têm prioridade sobre as configurações globais. Use 0 para ilimitado.",
  ...
  "components.AddressSelect.copy": "Copiar endereço de e-mail",
  ...
  "views.admin.CreateAccount.creatNewEmail": "Criar endereço de e-mail",
  "views.common.Login.getNewEmail": "Criar endereço de e-mail",
  "views.user.AddressManagement.create_or_bind": "Adicionar caixa de correio",
  "views.index.LocalAddress.create_or_bind": "Adicionar caixa de correio",
  ...
  "views.index.AccountSettings.deleteAccount": "Excluir caixa de correio",
  "views.admin.Account.deleteAccount": "Excluir caixa de correio",
  ...
  "views.user.UserLogin.email": "E-mail da conta",
  "views.admin.UserManagement.email": "E-mail da conta",
  "views.common.Login.email": "Endereço de e-mail",
  "views.common.Login.credential": "Credencial do endereço",
  "views.common.Login.emailPasswordRequired": "O endereço de e-mail e a senha da caixa de correio são obrigatórios",
  ...
  "views.common.Login.bindUserAddressError": "Não foi possível vincular o endereço de e-mail à conta de usuário",
  ...
  "views.Header.home": "Caixa de correio",
  ...
  "views.admin.Account.addressQueryTip": "Deixe em branco para consultar todos os endereços de e-mail",
  ...
  "components.AddressSelect.localAddresses": "Caixas de correio locais",
  "views.common.Login.bindUserInfo": "Você está conectado a uma conta de usuário. Entrar em uma caixa de correio não vinculada ou criar uma nova irá vinculá-la à conta de usuário atual.",
  "views.user.UserOauth2Callback.logging": "Entrando...",
  "views.user.UserLogin.login": "Entrar",
  "views.common.Login.login": "Entrar na caixa de correio",
  ...
  "views.index.AccountSettings.logout": "Sair da caixa de correio",
  ...
  "views.index.SimpleIndex.addressCredential": "Credencial do endereço",
  "views.index.AddressBar.addressCredential": "Credencial do endereço",
  "views.admin.Account.addressCredential": "Credencial do endereço",
  "views.admin.CreateAccount.addressCredential": "Credencial do endereço",
  "views.index.AddressBar.fetchAddressError": "A credencial do endereço é inválida ou o endereço de e-mail não existe. Também pode ser um problema de rede. Tente novamente mais tarde.",
  ...
  "views.index.AddressBar.addressManage": "Gerenciamento de caixas de correio",
  "views.admin.AccountSettings.source_match_mode": "Modo de correspondência",
  "views.admin.RoleAddressConfig.maxAddressCount": "Máximo de caixas de correio (0 = ilimitado)",
  "views.admin.UserSettings.maxAddressCount": "Número máximo de caixas de correio vinculadas (0 = ilimitado)",
  ...
  "views.user.AddressManagement.name": "Endereço de e-mail",
  "views.index.AutoReply.name": "Nome",
  "views.admin.Account.name": "Endereço de e-mail",
  "views.admin.UserOauth2Settings.name": "Nome",
  "views.admin.UserAddressManagement.name": "Endereço de e-mail",
  ...
  "views.common.Login.password": "Senha da caixa de correio",
  ...
  "views.index.SimpleIndex.addressCredentialTip": "Copie a credencial do endereço para acessar esta caixa de correio.",
  "views.index.AddressBar.addressCredentialTip": "Copie a credencial do endereço para acessar esta caixa de correio.",
  "views.admin.Account.addressCredentialTip": "Copie a credencial do endereço para acessar esta caixa de correio.",
  "views.admin.CreateAccount.addressCredentialTip": "Copie a credencial do endereço para acessar esta caixa de correio.",
  ...
  "views.user.UserLogin.pleaseInputEmail": "Digite o e-mail da conta",
  "views.user.UserLogin.pleaseInput": "Digite o e-mail da conta e a senha",
  ...
  "views.common.Login.credentialInput": "Digite a credencial do endereço",
  "views.admin.SenderAccess.modalTip": "Informe o saldo de envio",
  "views.user.UserLogin.pleaseLogin": "Faça login",
  "views.common.Login.pleaseGetNewEmail": "Entre em uma caixa de correio ou selecione “Criar endereço de e-mail”.",
  ...
  "views.admin.Account.pleaseSelectAddress": "Selecione uma caixa de correio",
  ...
  "views.Admin.roleAddressConfig": "Limites de caixas de correio por função",
  ...
  "views.Index.sendbox": "Enviados",
  "views.Admin.sendBox": "Enviados",
  ...
  "views.index.AccountSettings.showAddressCredential": "Credenciais da caixa de correio e métodos de conexão",
  ...
  "views.admin.Account.showCredential": "Exibir credencial do endereço",
  ...
  "views.index.LocalAddress.tip": "Estas credenciais de caixas de correio são armazenadas no navegador e podem ser perdidas ao limpar os dados do navegador.",
  ...
  "views.user.AddressManagement.transferAddress": "Transferir caixa de correio",
  "views.user.AddressManagement.transferAddressTip": "Esta caixa de correio será desvinculada da conta de usuário atual e vinculada à conta de destino.",
  ...
  "views.user.AddressManagement.unbindAddress": "Desvincular caixa de correio",
  "views.index.TelegramAddress.unbindMailAddress": "Desvincular caixa de correio",
  "views.index.LocalAddress.unbindMailAddress": "Remover caixa de correio local",
  ...
  "views.Header.user": "Central do usuário",
  "views.Admin.user": "Usuário",
  "components.AddressSelect.userAddresses": "Caixas de correio vinculadas",
  ...
  "views.index.AddressBar.userLogin": "Central do usuário",
  ...
  "components.AddressCredentialModal.addressPassword": "Senha da caixa de correio",
  ...
  "components.AddressCredentialModal.currentAddress": "Endereço de e-mail atual",
  ...
  "components.AddressCredentialModal.smtpImapTip": "Use estes valores em clientes de e-mail depois que o administrador configurar o proxy SMTP/IMAP. Como senha, você pode usar o Address JWT exibido aqui ou a senha da caixa de correio.",
  ...
  "components.AddressCredentialModal.title": "Credenciais da caixa de correio e métodos de conexão",
