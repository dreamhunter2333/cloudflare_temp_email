export const jaMessages = {
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_tip": "一致するベースドメインでランダムサブドメインも有効な場合に限り、/api/new_address と /admin/new_address で手動サブドメインを許可します。",
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_note": "これは RANDOM_SUBDOMAIN_DOMAINS 内の手動モードです。呼び出し側がサブドメインを入力し、ランダムモードでは自動生成します。",
  ...
  "views.admin.CreateAccount.customSubdomain": "カスタムサブドメイン",
  "views.admin.CreateAccount.customSubdomainTip": "サブドメイン部分のみ入力してください。このモードはランダムサブドメインを許可したベースドメインでのみ利用できます。",
  "views.admin.CreateAccount.enableCustomSubdomain": "カスタムサブドメインを使用",
  "views.common.Login.customSubdomain": "カスタムサブドメイン",
  "views.common.Login.customSubdomainRequired": "カスタムサブドメインを入力してください。",
  "views.common.Login.customSubdomainTip": "サブドメイン部分のみ入力してください。このモードはランダムサブドメインを許可したベースドメインでのみ利用できます。",
