export const jaMessages = {
  ...
  "views.user.AddressManagement.address": "メールアドレス",
  ...
  "views.User.address_management": "メールアドレス管理",
  ...
  "views.admin.SenderAccess.balance": "送信残高",
  ...
  "views.user.AddressManagement.create_or_bind": "メールアドレスを作成または紐付け",
  ...
  "views.user.UserLogin.email": "ユーザーアカウントのメール",
  ...
  "views.user.UserBar.fetchUserSettingsError": "ログイン情報の有効期限が切れているか、ユーザーアカウントが存在しません。ネットワーク接続の問題の可能性もあるため、後でもう一度お試しください。",
  ...
  "views.index.AccountSettings.logout": "アドレスからログアウト",
  ...
  "views.user.UserLogin.pleaseInputEmail": "ユーザーアカウントのメールを入力してください",
  "views.user.UserLogin.pleaseInput": "ユーザーアカウントのメールとパスワードを入力してください",
  ...
  "views.admin.SenderAccess.modalTip": "このメールアドレスの送信残高を設定してください",
  ...
  "views.index.SendMail.requestAccess": "現在のアドレスで申請",
  ...
  "views.Admin.senderAccess": "メールアドレス送信権限",
  ...
  "views.user.AddressManagement.targetUserEmail": "移行先ユーザーアカウントのメール",
  ...
  "views.user.AddressManagement.transferAddressTip": "このメールアドレスを移行すると、あなたのユーザーアカウントとの紐付けが解除され、移行先のユーザーアカウントに紐付けられます。続行しますか？",
