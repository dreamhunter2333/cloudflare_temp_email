export const jaMessages = {
  ...
  "views.admin.CreateAccount.customSubdomainTip": "ドメインを選択するか、team.example.com のようなカスタムサブドメインを入力してください。サブドメイン接尾辞一致を有効にする必要があります。",
  ...
  "views.common.Login.getNewEmailTip3": "ドメインを選択するか、team.example.com のようなカスタムサブドメインを入力してください。サブドメイン接尾辞一致を有効にする必要があります。",
