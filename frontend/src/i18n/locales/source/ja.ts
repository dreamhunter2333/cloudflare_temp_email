export const jaMessages = {
  ...
  "views.Admin.account": "メールボックス管理",
  "views.Admin.account_list": "メールボックス一覧",
  "views.Index.accountSettings": "メールボックス設定",
  "views.Admin.account_settings": "メールボックス全体設定",
  "views.index.SimpleIndex.accountSettings": "メールボックス設定",
  ...
  "components.AddressSelect.address": "メールボックスを選択",
  "views.user.AddressManagement.address": "メールボックス",
  "views.index.TelegramAddress.address": "メールボックス",
  "views.admin.SenderAccess.address": "メールアドレス",
  "views.index.LocalAddress.address": "ローカルメールボックス",
  "views.admin.CreateAccount.address": "メールアドレス",
  ...
  "views.index.SimpleIndex.addressCopied": "メールアドレスをコピーしました",
  "views.admin.Statistics.addressCount": "アドレス数",
  "views.admin.UserManagement.address_count": "メールボックス数",
  "views.User.address_management": "メールボックス管理",
  "views.admin.UserManagement.userAddressManagement": "メールボックス管理",
  "views.index.AddressBar.addressPassword": "メールボックスパスワード",
  "views.admin.CreateAccount.addressPassword": "メールボックスパスワード",
  ...
  "views.admin.Account.deleteTip": "メールボックス {address} とすべてのメールを削除してもよろしいですか？",
  "views.admin.SenderAccess.deleteTip": "これを削除してもよろしいですか？",
  "views.index.AccountSettings.deleteAccountConfirm": "メールボックス {address} とすべてのメールを削除しますか？ユーザーアカウントは削除されません。",
  ...
  "views.user.AddressManagement.unbindAddressTip": "連携解除前にこのメールボックスを開き、メールアドレス認証情報を保存してください。",
  "views.index.TelegramAddress.bind": "メールボックスを追加",
  "views.index.TelegramAddress.bindAddressSuccess": "メールボックスを連携しました",
  "views.index.LocalAddress.bindAddressSuccess": "メールボックスを追加しました",
  "views.User.bind_address": "メールアドレスを連携",
  ...
  "views.user.AddressManagement.changeMailAddress": "メールボックスを開く",
  "views.index.TelegramAddress.changeMailAddress": "メールボックスを切り替え",
  "views.index.LocalAddress.changeMailAddress": "メールボックスを切り替え",
  "views.index.AccountSettings.changePassword": "メールボックスパスワードを変更",
  ...
  "views.admin.RoleAddressConfig.roleConfigDesc": "ユーザーロールごとのメールボックス上限数を設定します。ロール別上限は全体設定より優先されます。0 は無制限です。",
  ...
  "components.AddressSelect.copy": "メールアドレスをコピー",
  ...
  "views.admin.CreateAccount.creatNewEmail": "メールアドレスを作成",
  "views.common.Login.getNewEmail": "メールアドレスを作成",
  "views.user.AddressManagement.create_or_bind": "メールボックスを追加",
  "views.index.LocalAddress.create_or_bind": "メールボックスを追加",
  ...
  "views.user.UserBar.currentUser": "現在のユーザー",
  ...
  "views.index.AccountSettings.deleteAccount": "メールボックスを削除",
  "views.admin.Account.deleteAccount": "メールボックスを削除",
  ...
  "views.user.UserLogin.email": "アカウントのメールアドレス",
  "views.admin.UserManagement.email": "アカウントのメールアドレス",
  "views.common.Login.email": "メールアドレス",
  "views.common.Login.credential": "メールアドレス認証情報",
  "views.common.Login.emailPasswordRequired": "メールアドレスとメールボックスパスワードを入力してください",
  ...
  "views.common.Login.bindUserAddressError": "メールアドレスをユーザーアカウントに連携できませんでした",
  ...
  "views.admin.Account.addressQueryTip": "空欄の場合はすべてのメールアドレスを検索",
  ...
  "components.AddressSelect.localAddresses": "ローカルメールボックス",
  "views.common.Login.bindUserInfo": "ユーザーアカウントにログインしています。未連携のメールボックスへのログインまたは新規作成により、現在のユーザーアカウントへ連携されます。",
  "views.user.UserOauth2Callback.logging": "ログイン中...",
  "views.user.UserLogin.login": "ログイン",
  "views.common.Login.login": "メールボックスにログイン",
  ...
  "views.index.AccountSettings.logout": "メールボックスからログアウト",
  ...
  "views.index.SimpleIndex.addressCredential": "メールアドレス認証情報",
  "views.index.AddressBar.addressCredential": "メールアドレス認証情報",
  "views.admin.Account.addressCredential": "メールアドレス認証情報",
  "views.admin.CreateAccount.addressCredential": "メールアドレス認証情報",
  "views.index.AddressBar.fetchAddressError": "メールアドレス認証情報が無効か、メールアドレスが存在しません。ネットワークの問題である可能性もあります。後でもう一度お試しください。",
  ...
  "views.index.AddressBar.addressManage": "メールボックス管理",
  "views.admin.AccountSettings.source_match_mode": "一致モード",
  "views.admin.RoleAddressConfig.maxAddressCount": "メールボックス上限数（0 = 無制限）",
  "views.admin.UserSettings.maxAddressCount": "連携できるメールボックスの最大数（0 = 無制限）",
  ...
  "views.user.AddressManagement.name": "メールアドレス",
  "views.index.AutoReply.name": "名前",
  "views.admin.Account.name": "メールアドレス",
  "views.admin.UserOauth2Settings.name": "名前",
  "views.admin.UserAddressManagement.name": "メールアドレス",
  ...
  "views.common.Login.password": "メールボックスパスワード",
  ...
  "views.index.SimpleIndex.addressCredentialTip": "このメールボックスにアクセスするため、メールアドレス認証情報をコピーしてください。",
  "views.index.AddressBar.addressCredentialTip": "このメールボックスにアクセスするため、メールアドレス認証情報をコピーしてください。",
  "views.admin.Account.addressCredentialTip": "このメールボックスにアクセスするため、メールアドレス認証情報をコピーしてください。",
  "views.admin.CreateAccount.addressCredentialTip": "このメールボックスにアクセスするため、メールアドレス認証情報をコピーしてください。",
  ...
  "views.Admin.roleAddressConfig": "ロール別メールボックス上限",
  ...
  "views.Index.sendbox": "送信済み",
  "views.Admin.sendBox": "送信済み",
  ...
  "views.index.AccountSettings.showAddressCredential": "メールボックス認証情報と接続方法",
  ...
  "views.admin.Account.showCredential": "メールアドレス認証情報を表示",
  ...
  "views.index.LocalAddress.tip": "これらのメールボックス認証情報はブラウザーに保存され、ブラウザーデータを削除すると失われる場合があります。",
  ...
  "views.user.AddressManagement.transferAddress": "メールボックスを移管",
  "views.user.AddressManagement.transferAddressTip": "このメールボックスは現在のユーザーアカウントから連携解除され、移管先のアカウントに連携されます。",
  ...
  "views.user.AddressManagement.unbindAddress": "メールボックスの連携を解除",
  "views.index.TelegramAddress.unbindMailAddress": "メールボックスの連携を解除",
  "views.index.LocalAddress.unbindMailAddress": "ローカルメールボックスを削除",
  ...
  "views.Header.user": "ユーザーセンター",
  "views.Admin.user": "ユーザー",
  "components.AddressSelect.userAddresses": "連携済みメールボックス",
  ...
  "views.index.AddressBar.userLogin": "ユーザーセンター",
  ...
  "components.AddressCredentialModal.addressCredential": "メールアドレス認証情報",
  "components.AddressCredentialModal.addressCredentialLabel": "Address JWT",
  "components.AddressCredentialModal.addressPassword": "メールボックスパスワード",
  ...
  "components.AddressCredentialModal.currentAddress": "現在のメールアドレス",
  ...
  "components.AddressCredentialModal.smtpImapTip": "管理者が SMTP/IMAP プロキシを設定した後、これらの値をメールクライアントで使用できます。パスワードには、ここに表示される Address JWT またはメールボックスパスワードを使用できます。",
  ...
  "components.AddressCredentialModal.title": "メールボックス認証情報と接続方法",
