export const deMessages = {
  ...
  "views.Admin.account": "Postfachverwaltung",
  "views.Admin.account_list": "Postfächer",
  "views.Index.accountSettings": "Postfacheinstellungen",
  "views.Admin.account_settings": "Globale Postfacheinstellungen",
  "views.index.SimpleIndex.accountSettings": "Postfacheinstellungen",
  ...
  "components.AddressSelect.address": "Postfach auswählen",
  "views.user.AddressManagement.address": "Postfächer",
  "views.index.TelegramAddress.address": "Postfächer",
  "views.admin.SenderAccess.address": "E-Mail-Adresse",
  "views.index.LocalAddress.address": "Lokale Postfächer",
  "views.admin.CreateAccount.address": "E-Mail-Adresse",
  ...
  "views.index.SimpleIndex.addressCopied": "E-Mail-Adresse kopiert",
  "views.admin.Statistics.addressCount": "Adressanzahl",
  "views.admin.UserManagement.address_count": "Postfachanzahl",
  "views.User.address_management": "Postfachverwaltung",
  "views.admin.UserManagement.userAddressManagement": "Postfachverwaltung",
  "views.index.AddressBar.addressPassword": "Postfachpasswort",
  "views.admin.CreateAccount.addressPassword": "Postfachpasswort",
  "views.Admin.adminAccount": "Administrator",
  "views.Admin.accessHeader": "Admin-Passwort",
  "views.Admin.loginViaPassword": "Anmeldung mit Admin-Passwort",
  ...
  "views.admin.Account.deleteTip": "Möchtest du das Postfach {address} und alle zugehörigen E-Mails wirklich löschen?",
  "views.admin.SenderAccess.deleteTip": "Möchtest du dies wirklich löschen?",
  "views.index.AccountSettings.deleteAccountConfirm": "Möchtest du das Postfach {address} und alle zugehörigen E-Mails wirklich löschen? Dein Benutzerkonto wird dabei nicht gelöscht.",
  ...
  "views.Admin.logoutConfirmContent": "Möchtest du dich wirklich von der Admin-Konsole abmelden?",
  ...
  "views.user.AddressManagement.unbindAddressTip": "Öffne dieses Postfach vor dem Trennen und speichere die Adresszugangsdaten.",
  "views.index.TelegramAddress.bind": "Postfach hinzufügen",
  "views.index.TelegramAddress.bindAddressSuccess": "Postfach erfolgreich verknüpft",
  "views.index.LocalAddress.bindAddressSuccess": "Postfach erfolgreich hinzugefügt",
  "views.User.bind_address": "E-Mail-Adresse verknüpfen",
  ...
  "views.user.AddressManagement.changeMailAddress": "Postfach öffnen",
  "views.index.TelegramAddress.changeMailAddress": "Postfach wechseln",
  "views.index.LocalAddress.changeMailAddress": "Postfach wechseln",
  "views.index.AccountSettings.changePassword": "Postfachpasswort ändern",
  ...
  "views.admin.RoleAddressConfig.roleConfigDesc": "Lege die maximale Anzahl von Postfächern pro Benutzerrolle fest. Rollenbasierte Limits haben Vorrang vor globalen Einstellungen. Verwende 0 für unbegrenzt.",
  ...
  "components.AddressSelect.copy": "E-Mail-Adresse kopieren",
  ...
  "views.admin.CreateAccount.creatNewEmail": "E-Mail-Adresse erstellen",
  "views.common.Login.getNewEmail": "E-Mail-Adresse erstellen",
  "views.user.AddressManagement.create_or_bind": "Postfach hinzufügen",
  "views.index.LocalAddress.create_or_bind": "Postfach hinzufügen",
  ...
  "views.user.UserBar.currentUser": "Aktueller Benutzer",
  ...
  "views.index.AccountSettings.deleteAccount": "Postfach löschen",
  "views.admin.Account.deleteAccount": "Postfach löschen",
  ...
  "views.user.UserLogin.email": "Konto-E-Mail-Adresse",
  "views.admin.UserManagement.email": "Konto-E-Mail-Adresse",
  "views.common.Login.email": "E-Mail-Adresse",
  "views.common.Login.credential": "Adresszugangsdaten",
  "views.common.Login.emailPasswordRequired": "E-Mail-Adresse und Postfachpasswort sind erforderlich",
  ...
  "views.common.Login.bindUserAddressError": "Die E-Mail-Adresse konnte nicht mit dem Benutzerkonto verknüpft werden",
  ...
  "views.admin.Account.addressQueryTip": "Leer lassen, um alle E-Mail-Adressen abzufragen",
  ...
  "components.AddressSelect.localAddresses": "Lokale Postfächer",
  "views.common.Login.bindUserInfo": "Du bist mit einem Benutzerkonto angemeldet. Ein nicht verknüpftes Postfach oder ein neu erstelltes Postfach wird mit dem aktuellen Benutzerkonto verknüpft.",
  "views.user.UserOauth2Callback.logging": "Anmeldung läuft...",
  "views.user.UserLogin.login": "Anmelden",
  "views.common.Login.login": "Beim Postfach anmelden",
  ...
  "views.index.AccountSettings.logout": "Vom Postfach abmelden",
  ...
  "views.index.SimpleIndex.addressCredential": "Adresszugangsdaten",
  "views.index.AddressBar.addressCredential": "Adresszugangsdaten",
  "views.admin.Account.addressCredential": "Adresszugangsdaten",
  "views.admin.CreateAccount.addressCredential": "Adresszugangsdaten",
  "views.index.AddressBar.fetchAddressError": "Die Adresszugangsdaten sind ungültig oder die E-Mail-Adresse existiert nicht. Es kann auch ein Netzwerkproblem vorliegen. Bitte versuche es später erneut.",
  ...
  "views.index.AddressBar.addressManage": "Postfachverwaltung",
  "views.admin.AccountSettings.source_match_mode": "Abgleichsmodus",
  "views.admin.RoleAddressConfig.maxAddressCount": "Maximale Postfachanzahl (0 = unbegrenzt)",
  "views.admin.UserSettings.maxAddressCount": "Maximale Anzahl verknüpfter Postfächer (0 = unbegrenzt)",
  ...
  "views.user.AddressManagement.name": "E-Mail-Adresse",
  "views.index.AutoReply.name": "Name",
  "views.admin.Account.name": "E-Mail-Adresse",
  "views.admin.UserOauth2Settings.name": "Name",
  "views.admin.UserAddressManagement.name": "E-Mail-Adresse",
  ...
  "views.common.Login.password": "Postfachpasswort",
  ...
  "views.index.SimpleIndex.addressCredentialTip": "Kopiere die Adresszugangsdaten, um auf dieses Postfach zuzugreifen.",
  "views.index.AddressBar.addressCredentialTip": "Kopiere die Adresszugangsdaten, um auf dieses Postfach zuzugreifen.",
  "views.admin.Account.addressCredentialTip": "Kopiere die Adresszugangsdaten, um auf dieses Postfach zuzugreifen.",
  "views.admin.CreateAccount.addressCredentialTip": "Kopiere die Adresszugangsdaten, um auf dieses Postfach zuzugreifen.",
  ...
  "views.user.UserLogin.pleaseInputEmail": "Bitte die Konto-E-Mail-Adresse eingeben",
  "views.user.UserLogin.pleaseInput": "Bitte Konto-E-Mail-Adresse und Passwort eingeben",
  ...
  "views.common.Login.credentialInput": "Bitte die Adresszugangsdaten eingeben",
  "views.admin.SenderAccess.modalTip": "Bitte das Sendeguthaben eingeben",
  "views.user.UserLogin.pleaseLogin": "Bitte anmelden",
  "views.common.Login.pleaseGetNewEmail": "Melde dich bei einem Postfach an oder wähle „E-Mail-Adresse erstellen“.",
  ...
  "views.admin.Account.pleaseSelectAddress": "Bitte ein Postfach auswählen",
  ...
  "views.Admin.roleAddressConfig": "Postfachlimits nach Rolle",
  ...
  "views.Index.sendbox": "Gesendet",
  "views.Admin.sendBox": "Gesendet",
  ...
  "views.index.AccountSettings.showAddressCredential": "Postfachzugangsdaten & Verbindungsmethoden",
  ...
  "views.admin.Account.showCredential": "Adresszugangsdaten anzeigen",
  ...
  "views.index.LocalAddress.tip": "Diese Postfachzugangsdaten werden in deinem Browser gespeichert und können beim Löschen der Browserdaten verloren gehen.",
  ...
  "views.user.AddressManagement.transferAddress": "Postfach übertragen",
  "views.user.AddressManagement.transferAddressTip": "Dieses Postfach wird vom aktuellen Benutzerkonto getrennt und mit dem Zielkonto verknüpft.",
  ...
  "views.user.AddressManagement.unbindAddress": "Postfachverknüpfung lösen",
  "views.index.TelegramAddress.unbindMailAddress": "Postfachverknüpfung lösen",
  "views.index.LocalAddress.unbindMailAddress": "Lokales Postfach entfernen",
  ...
  "views.Header.user": "Benutzerbereich",
  "views.Admin.user": "Benutzer",
  "components.AddressSelect.userAddresses": "Verknüpfte Postfächer",
  "views.Admin.loginViaUserAdmin": "Benutzerkonto (Admin-Rolle)",
  "views.admin.Statistics.userCount": "Benutzeranzahl",
  "views.admin.UserManagement.user_email": "Benutzer-E-Mail",
  "views.index.AddressBar.userLogin": "Benutzerbereich",
  ...
  "components.AddressCredentialModal.addressPassword": "Postfachpasswort",
  ...
  "components.AddressCredentialModal.currentAddress": "Aktuelle E-Mail-Adresse",
  ...
  "components.AddressCredentialModal.smtpImapTip": "Verwende diese Werte in Mail-Clients, nachdem der Administrator den SMTP/IMAP-Proxy konfiguriert hat. Als Passwort kannst du den hier angezeigten Address JWT oder ein vorhandenes Postfachpasswort verwenden.",
  ...
  "components.AddressCredentialModal.title": "Postfachzugangsdaten & Verbindungsmethoden",
