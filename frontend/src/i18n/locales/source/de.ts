export const deMessages = {
  ...
  "views.Index.accountSettings": "E-Mail-Adresseinstellungen",
  "views.Admin.account_settings": "Kontoeinstellungen",
  "views.index.SimpleIndex.accountSettings": "E-Mail-Adresseinstellungen",
  ...
  "views.user.AddressManagement.address": "E-Mail-Adressen",
  ...
  "views.User.address_management": "E-Mail-Adressverwaltung",
  ...
  "views.admin.SenderAccess.balance": "Sendeguthaben",
  ...
  "views.user.AddressManagement.create_or_bind": "E-Mail-Adresse erstellen oder verknüpfen",
  ...
  "views.user.UserLogin.email": "E-Mail des Benutzerkontos",
  ...
  "views.user.UserBar.fetchUserSettingsError": "Die Anmeldeinformationen sind abgelaufen oder das Benutzerkonto existiert nicht. Es könnte auch ein Netzwerkproblem vorliegen. Bitte später erneut versuchen.",
  ...
  "views.index.AccountSettings.logout": "Von Adresse abmelden",
  ...
  "views.user.UserLogin.pleaseInputEmail": "Bitte die E-Mail des Benutzerkontos eingeben",
  "views.user.UserLogin.pleaseInput": "Bitte E-Mail und Passwort des Benutzerkontos eingeben",
  ...
  "views.admin.SenderAccess.modalTip": "Sendeguthaben für diese E-Mail-Adresse festlegen",
  ...
  "views.index.SendMail.requestAccess": "Für aktuelle Adresse anfordern",
  ...
  "views.Admin.senderAccess": "Sendeberechtigung für E-Mail-Adressen",
  ...
  "views.user.AddressManagement.targetUserEmail": "E-Mail des Zielbenutzerkontos",
  ...
  "views.user.AddressManagement.transferAddressTip": "Beim Übertragen wird diese E-Mail-Adresse von deinem Benutzerkonto gelöst und mit dem Zielbenutzerkonto verknüpft. Möchtest du fortfahren?",
  ...
  "views.User.user_settings": "Benutzerkontoeinstellungen",
