export const deMessages = {
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_tip": "Erlaubt /api/new_address und /admin/new_address manuell eingegebene Subdomains nur, wenn die passende Basisdomain auch für zufällige Subdomains aktiviert ist.",
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_note": "Dies ist der manuelle Modus innerhalb von RANDOM_SUBDOMAIN_DOMAINS: Aufrufer geben die Subdomain ein, während der Zufallsmodus sie automatisch erzeugt.",
  ...
  "views.admin.CreateAccount.customSubdomain": "Benutzerdefinierte Subdomain",
  "views.admin.CreateAccount.customSubdomainTip": "Gib nur den Subdomain-Teil ein. Dieser Modus ist nur für Basisdomains verfügbar, die zufällige Subdomains erlauben.",
  "views.admin.CreateAccount.enableCustomSubdomain": "Benutzerdefinierte Subdomain verwenden",
  "views.common.Login.customSubdomain": "Benutzerdefinierte Subdomain",
  "views.common.Login.customSubdomainRequired": "Bitte gib eine benutzerdefinierte Subdomain ein.",
  "views.common.Login.customSubdomainTip": "Gib nur den Subdomain-Teil ein. Dieser Modus ist nur für Basisdomains verfügbar, die zufällige Subdomains erlauben.",
