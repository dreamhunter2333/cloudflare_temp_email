export const esMessages = {
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_tip": "Permite que /api/new_address y /admin/new_address acepten subdominios manuales solo si el dominio base también admite subdominios aleatorios.",
  ...
  "views.admin.AccountSettings.create_address_subdomain_match_note": "Este es el modo manual dentro de RANDOM_SUBDOMAIN_DOMAINS: el usuario introduce el subdominio y el modo aleatorio lo genera automáticamente.",
  ...
  "views.admin.CreateAccount.customSubdomain": "Subdominio personalizado",
  "views.admin.CreateAccount.customSubdomainTip": "Introduce solo la parte del subdominio. Este modo solo está disponible para dominios base que permiten subdominios aleatorios.",
  "views.admin.CreateAccount.enableCustomSubdomain": "Usar subdominio personalizado",
  "views.common.Login.customSubdomain": "Subdominio personalizado",
  "views.common.Login.customSubdomainRequired": "Introduce un subdominio personalizado.",
  "views.common.Login.customSubdomainTip": "Introduce solo la parte del subdominio. Este modo solo está disponible para dominios base que permiten subdominios aleatorios.",
