export const esMessages = {
  ...
  "views.Admin.account": "Gestión de buzones",
  "views.Admin.account_list": "Buzones",
  "views.Index.accountSettings": "Configuración del buzón",
  "views.Admin.account_settings": "Configuración global de buzones",
  "views.index.SimpleIndex.accountSettings": "Configuración del buzón",
  ...
  "components.AddressSelect.address": "Seleccionar buzón",
  "views.user.AddressManagement.address": "Buzones",
  "views.index.TelegramAddress.address": "Buzones",
  "views.admin.SenderAccess.address": "Dirección de correo",
  "views.index.LocalAddress.address": "Buzones locales",
  "views.admin.CreateAccount.address": "Dirección de correo",
  ...
  "views.index.SimpleIndex.addressCopied": "Dirección de correo copiada",
  "views.admin.Statistics.addressCount": "Cantidad de direcciones",
  "views.admin.UserManagement.address_count": "Cantidad de buzones",
  "views.User.address_management": "Gestión de buzones",
  "views.admin.UserManagement.userAddressManagement": "Gestión de buzones",
  "views.index.AddressBar.addressPassword": "Contraseña del buzón",
  "views.admin.CreateAccount.addressPassword": "Contraseña del buzón",
  "views.Admin.adminAccount": "Administrador",
  "views.Admin.accessHeader": "Contraseña de administrador",
  "views.Admin.loginViaPassword": "Inicio de sesión con contraseña de administrador",
  ...
  "views.admin.Account.deleteTip": "¿Seguro que quieres eliminar el buzón {address} y todos sus correos?",
  "views.admin.SenderAccess.deleteTip": "¿Seguro que quieres eliminar esto?",
  "views.index.AccountSettings.deleteAccountConfirm": "¿Seguro que quieres eliminar el buzón {address} y todos sus correos? Esto no elimina tu cuenta de usuario.",
  ...
  "views.Admin.logoutConfirmContent": "¿Seguro que quieres cerrar sesión en la consola de administración?",
  ...
  "views.user.AddressManagement.unbindAddressTip": "Abre este buzón antes de desvincularlo y guarda la credencial de la dirección.",
  "views.index.TelegramAddress.bind": "Añadir buzón",
  "views.index.TelegramAddress.bindAddressSuccess": "Buzón vinculado correctamente",
  "views.index.LocalAddress.bindAddressSuccess": "Buzón añadido correctamente",
  ...
  "views.user.AddressManagement.changeMailAddress": "Abrir buzón",
  "views.index.TelegramAddress.changeMailAddress": "Cambiar de buzón",
  "views.index.LocalAddress.changeMailAddress": "Cambiar de buzón",
  "views.index.AccountSettings.changePassword": "Cambiar contraseña del buzón",
  ...
  "views.admin.RoleAddressConfig.roleConfigDesc": "Configura el número máximo de buzones para cada rol de usuario. Los límites por rol tienen prioridad sobre la configuración global. Usa 0 para ilimitado.",
  ...
  "components.AddressSelect.copy": "Copiar dirección de correo",
  ...
  "views.admin.CreateAccount.creatNewEmail": "Crear dirección de correo",
  "views.common.Login.getNewEmail": "Crear dirección de correo",
  "views.user.AddressManagement.create_or_bind": "Añadir buzón",
  "views.index.LocalAddress.create_or_bind": "Añadir buzón",
  ...
  "views.index.AccountSettings.deleteAccount": "Eliminar buzón",
  "views.admin.Account.deleteAccount": "Eliminar buzón",
  ...
  "views.user.UserLogin.email": "Correo de la cuenta",
  "views.admin.UserManagement.email": "Correo de la cuenta",
  "views.common.Login.email": "Dirección de correo",
  "views.common.Login.credential": "Credencial de la dirección",
  "views.common.Login.emailPasswordRequired": "La dirección de correo y la contraseña del buzón son obligatorias",
  ...
  "views.common.Login.bindUserAddressError": "No se pudo vincular la dirección de correo a la cuenta de usuario",
  ...
  "views.admin.Account.addressQueryTip": "Déjalo vacío para consultar todas las direcciones de correo",
  ...
  "components.AddressSelect.localAddresses": "Buzones locales",
  "views.common.Login.bindUserInfo": "Has iniciado sesión con una cuenta de usuario. Un buzón sin vincular o uno nuevo se vinculará a la cuenta de usuario actual.",
  "views.user.UserOauth2Callback.logging": "Iniciando sesión...",
  "views.user.UserLogin.login": "Iniciar sesión",
  "views.common.Login.login": "Iniciar sesión en el buzón",
  ...
  "views.index.AccountSettings.logout": "Cerrar sesión en el buzón",
  ...
  "views.index.SimpleIndex.addressCredential": "Credencial de la dirección",
  "views.index.AddressBar.addressCredential": "Credencial de la dirección",
  "views.admin.Account.addressCredential": "Credencial de la dirección",
  "views.admin.CreateAccount.addressCredential": "Credencial de la dirección",
  "views.index.AddressBar.fetchAddressError": "La credencial de la dirección no es válida o la dirección de correo no existe. También puede ser un problema de red. Inténtalo de nuevo más tarde.",
  ...
  "views.index.AddressBar.addressManage": "Gestión de buzones",
  "views.admin.AccountSettings.source_match_mode": "Modo de coincidencia",
  "views.admin.RoleAddressConfig.maxAddressCount": "Máximo de buzones (0 = ilimitado)",
  "views.admin.UserSettings.maxAddressCount": "Número máximo de buzones vinculados (0 = ilimitado)",
  ...
  "views.user.AddressManagement.name": "Dirección de correo",
  "views.index.AutoReply.name": "Nombre",
  "views.admin.Account.name": "Dirección de correo",
  "views.admin.UserOauth2Settings.name": "Nombre",
  "views.admin.UserAddressManagement.name": "Dirección de correo",
  ...
  "views.common.Login.password": "Contraseña del buzón",
  ...
  "views.index.SimpleIndex.addressCredentialTip": "Copia la credencial de la dirección para acceder a este buzón.",
  "views.index.AddressBar.addressCredentialTip": "Copia la credencial de la dirección para acceder a este buzón.",
  "views.admin.Account.addressCredentialTip": "Copia la credencial de la dirección para acceder a este buzón.",
  "views.admin.CreateAccount.addressCredentialTip": "Copia la credencial de la dirección para acceder a este buzón.",
  ...
  "views.user.UserLogin.pleaseInputEmail": "Introduce el correo de la cuenta",
  "views.user.UserLogin.pleaseInput": "Introduce el correo de la cuenta y la contraseña",
  ...
  "views.common.Login.credentialInput": "Introduce la credencial de la dirección",
  "views.admin.SenderAccess.modalTip": "Introduce el saldo de envío",
  "views.user.UserLogin.pleaseLogin": "Inicia sesión",
  "views.common.Login.pleaseGetNewEmail": "Inicia sesión en un buzón o selecciona «Crear dirección de correo».",
  ...
  "views.admin.Account.pleaseSelectAddress": "Selecciona un buzón",
  ...
  "views.Admin.roleAddressConfig": "Límites de buzones por rol",
  ...
  "views.index.AccountSettings.showAddressCredential": "Credenciales del buzón y métodos de conexión",
  ...
  "views.admin.Account.showCredential": "Ver credencial de la dirección",
  ...
  "views.index.LocalAddress.tip": "Estas credenciales de buzón se guardan en el navegador y pueden perderse al borrar sus datos.",
  ...
  "views.user.AddressManagement.transferAddress": "Transferir buzón",
  "views.user.AddressManagement.transferAddressTip": "Este buzón se desvinculará de la cuenta de usuario actual y se vinculará a la cuenta de destino.",
  ...
  "views.user.AddressManagement.unbindAddress": "Desvincular buzón",
  "views.index.TelegramAddress.unbindMailAddress": "Desvincular buzón",
  "views.index.LocalAddress.unbindMailAddress": "Eliminar buzón local",
  ...
  "views.Header.user": "Centro de usuario",
  "views.Admin.user": "Usuario",
  "components.AddressSelect.userAddresses": "Buzones vinculados",
  ...
  "views.index.AddressBar.userLogin": "Centro de usuario",
  ...
  "components.AddressCredentialModal.addressCredential": "Credencial de la dirección",
  "components.AddressCredentialModal.addressCredentialLabel": "Address JWT",
  "components.AddressCredentialModal.addressPassword": "Contraseña del buzón",
  ...
  "components.AddressCredentialModal.currentAddress": "Dirección de correo actual",
  ...
  "components.AddressCredentialModal.smtpImapTip": "Usa estos valores en clientes de correo después de que el administrador configure el proxy SMTP/IMAP. Como contraseña puedes usar el Address JWT mostrado aquí o la contraseña del buzón.",
  ...
  "components.AddressCredentialModal.title": "Credenciales del buzón y métodos de conexión",
