...
- fix: |Address| Fix inbox, sendbox, and related settings returning empty results after password login with mixed-case email addresses by storing new addresses in lowercase and migrating historical address data to lowercase (#930)
