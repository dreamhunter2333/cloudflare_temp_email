...
- perf: |Worker| Limit each built-in cleanup run to 100 candidates and reuse one address snapshot when batch-deleting related data, avoiding unbounded deletes and repeated address-table scans (issue #1103)
