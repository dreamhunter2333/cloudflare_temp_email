...
- fix: |AI 提取| 将 AI 邮件识别默认 Workers AI 模型切换为未弃用的 `@cf/meta/llama-3.1-8b-instruct-fp8-fast`，并在文档中补充 `@cf/zai-org/glm-4.7-flash` 备选推荐（issue #1029）
- fix: |CI| 将 e2e Worker Docker 镜像升级到 Node.js LTS，适配 Wrangler 4.90.0 的运行时要求
